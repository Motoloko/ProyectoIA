...
int individuo[100][16], convertido[16],indDec[100], conjuntosOp = 0, hijos[20][2][16], padresUsados[2][20], conjuntos = 0, noConjOp = 0,mna[100];
...
void calAgru(){
	int conOp[16], conOps[100][16], i, j,adec[100];
	...
	cout<<"\n\nLos Conjuntos Optimos a decimal\n\n";
	for (int i = 0; i < noConjOp; ++i)
	{
		adec[i] = convadec(conOps[i]);
		printf("%d\n",adec[i]);
